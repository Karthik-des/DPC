...
const ConfirmPhoneForm = () => {
  ...
  const handleSave = () => {
    Alert.alert('Saved', 'Phone number submitted.');
    router.back();
  };
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={{ backgroundColor: '#ffffff', paddingTop: 50, paddingBottom: 12, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#F0F0F0' }}>
        ...
        <Text style={{ fontSize: 18, fontWeight: '700', color: '#111827' }}>Confirm Phone Number</Text>
        <View style={{ width: 40, height: 40 }} />
      </View>

      <View style={{ padding: 16 }}>
        <Text style={{ fontSize: 15, fontWeight: '600', color: '#374151', marginBottom: 8 }}>Phone Number</Text>
        <TextInput value={phone} onChangeText={setPhone} placeholder="Enter phone number" keyboardType="phone-pad" placeholderTextColor="#9CA3AF" style={{ height: 52, borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 12, paddingHorizontal: 16, backgroundColor: '#ffffff' }} />
      </View>
